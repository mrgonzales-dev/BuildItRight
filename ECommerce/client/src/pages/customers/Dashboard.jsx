...
import { api } from '../../api';
import { IconImage, IconSearch } from '../../icons';
import styles from '../../components/ProductCard.module.css';

export default function CustomerDashboard({ onCartChange }) {
