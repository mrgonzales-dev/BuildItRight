...
export default function CustomerOrders() {
  ...
  if (loading) {
    return (
      <div>
        <div className="page-header"><h3>My Orders</h3></div>
    ...
    <div className="order-cards-mobile">
      {orders.map((o) => (
        <div key={o.id} className="order-card">
          ...
          <div className="order-card-row">
            <span className="badge badge-status" style={{ fontSize: '0.7rem', fontWeight: 500, background: STATUS_COLORS[o.status]?.bg || '#f3f4f6', color: STATUS_COLORS[o.status]?.text || '#6b7280' }}>
          ...
          <div className="order-card-actions" style={{ marginTop: '0.4rem' }}>
